...
from ca_common.exchanges.binance import Binance
...
class Runner:
    ...
    def get_stream(self):
        """
            Getter for websocket stream
        """

        return self.__stream

    def __make_socket(self, host="0.0.0.0", port=6542, reuseport=False):
        """
            Socket creation
        """
...
if __name__ == '__main__':
    ...
    tasks = [runner.run(), runner.stream()]

    srv, app, handler = loop.run_until_complete(asyncio.gather(*tasks))
